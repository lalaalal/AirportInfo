...
public class AirportChartView extends ContentView {
    ...
    private final String[] attributeList = {"선택", "지역", "국가", "도시"};

    private AttributeStatisticCreator aSC;
    private AbstractChartView aCV;

    public AirportChartView(MainFrame mainFrame, AirportController paraApCon, AbstractChartView paraAcv, AttributeStatisticCreator attributeStatisticCreator) {

        super(mainFrame);
        apCon = paraApCon;
        aSC = attributeStatisticCreator;
        aCV = paraAcv;
        initComponent();
        initChartComboPanel();

        chartGUIPanel.add("West", chartViewPanel);
        chartGUIPanel.add("Center",chartComboPanel);
    }
